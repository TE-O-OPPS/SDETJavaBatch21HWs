package week5.d5.e2test;

import org.example.week5.d5.e2.E2NestedForLoops;
...
class E1NestedForLoopsTest {
    ...
    @Test
    void test2DArraysOutputWithLoops() {
        ...
        String failureMessage = "The output does not match the expected 2D array.\n" +
                "Please ensure that your program correctly initializes and prints the 2D array using nested loops.";
